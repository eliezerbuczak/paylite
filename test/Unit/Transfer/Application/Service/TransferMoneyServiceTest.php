...
class TransferMoneyServiceTest extends TestCase
{
    ...
    public function test_transfers_when_all_rules_pass(): void
    {
        ...
        $service = new TransferMoneyService($users, $wallets, $transfers, $authorizer);
    ...
    public function test_rejects_transfer_to_self_before_touching_any_port(): void
    {
        ...
        $service = new TransferMoneyService($users, $this->untouchedWallets(), $this->untouchedTransfers(), $this->untouchedAuthorizer());
    ...
    public function test_rejects_insufficient_balance_before_consulting_the_authorizer(): void
    {
        ...
        $service = new TransferMoneyService($users, $wallets, $transfers, $this->untouchedAuthorizer());
    ...
    public function test_rejects_transfer_when_authorizer_denies(): void
    {
        ...
        $service = new TransferMoneyService($users, $wallets, $transfers, $this->authorizerAnswering(false));
